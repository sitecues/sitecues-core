(function () {
    ...
    var sitecues, VERSION = 'UNVERSIONED';
    ...
    if (!sitecues.fallbackBasePath) {
        ...
        if (!sitecues.fallbackBasePath) {
            ...
            sitecues.fallbackBasePath = '/sitecues-js-fallback/src/';
        }
    }
    ...
    function init(msg) {
        ...
        if (IEv > 0 && IEv <= 6) {
            importCSS(
              sitecues.fallbackBasePath + 'css/sitecues-fallback-lteie6.css'
            );
        }
        ...
        function createBadge(success) {
            ...
            sitecuesFallbackImage.src   = sitecues.fallbackBasePath + 'img/sitecues-fallback-badge.png';
        ...
        function createFallback(success) {
            ...
            importCSS(sitecues.fallbackBasePath + 'css/sitecues-fallback.css');
            ...
            sitecuesLogo.src   = sitecues.fallbackBasePath + 'img/no-sitecues-support-warning.png';
