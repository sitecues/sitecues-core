...
function init(msg) {
    ...
    var $head = document.getElementsByTagName('head').item(0),
        ...
        var $fallback = document.getElementById('sitecuesFallback');
        
        if($badge === null){
            $badge = createBadge();
            setBadgeStyle($badge);
        }else{
            //$badge.attachEvent("onclick", toggleSitecuesModal);
            $badge.onclick = function(){
                toggleSitecuesModal()
            };
            //$badge.addEventListener("click", toggleSitecuesModal);
        }
...
function createBadge(success){
    ...
    $sitecuesFallbackImage.src = '../src/img/sitecues-fallback-badge.png';
...
function createFallback(success) {
    ...
    */
   importCSS('../src/css/fallback.css');
    ...
    $fallback.table = $messageHolder = document.createElement('div');
        ...
        $btnExplore.id = 'explore-btn';
            ...
            $fallback.btn1 = $btnDismissInt = document.createElement('a');
                ...
                $btnDismissInt.onclick = toggleSitecuesModal;
    ...
    */
    $fallback.sitecuesLogo = $sitecuesLogo = document.createElement('img');
        ...
        $sitecuesLogo.src = '../src/img/no-sitecues-support-warning.png';
