...
const create = (option) => {
    ...
    // The following CSS and ARIA attributes are here to ensure we pass automated accessibility tests.
    // We also try to avoid being read by screen readers, while providing a title just in case.
