...
const iframePath = 'html/global-storage.html';

// Create the storage iframe or return it if it already exists.
const createIframe = () => {
    const id = 'sitecues-global-storage';
    ...
    newFrame.id = id;
    newFrame.src = appUrl(iframePath);
    // This may improve security. We should enable it after verifying that it doesn't break anything.
